    ...
    public class NavMeshAssetManager : ScriptableSingleton<NavMeshAssetManager>
    {
        ...
        static string GetAndEnsureTargetPath(NavMeshSurface surface)
        {
            ...
            else
            {
                ...
                // vis2k: prefabStage.prefabAssetPath was obsoleted.
                // support both old and new Unity versions.
                ...
                if (isPartOfPrefab && !string.IsNullOrEmpty(prefabPath))
                {
                    var prefabDirectoryName = Path.GetDirectoryName(prefabPath);
