...
namespace WalletConnectSharp.Core
{
    public class WalletConnectProvider : WalletConnectProtocol
    {
        ...
        public WalletConnectProvider(SavedSession savedSession, ITransport transport = null, ICipher cipher = null, EventDelegator eventDelegator = null)
            : base(savedSession, transport, cipher, eventDelegator)
        {
        ...
        public WalletConnectProvider(string url, ITransport transport = null, ICipher cipher = null, int chainId = 1, EventDelegator eventDelegator = null)
            : base(transport, cipher, eventDelegator)
        {
